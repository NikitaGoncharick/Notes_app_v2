...
//--------------------NoteRepository  управляет логикой запросов к базе данных и предоставляет данные в удобном виде.---------------------//

//-----Изменения в данных отслеживаются через LiveData в ViewModel, которая затем автоматически информирует View об обновлениях.---//
